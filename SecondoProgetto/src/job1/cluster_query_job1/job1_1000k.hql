...
LOAD DATA LOCAL INPATH '1000k_historical_stock_prices_merged.csv' OVERWRITE INTO TABLE historical_stock_prices;

drop table historical_stock_prices_with_year;
...
drop table temp_start_end_dates;
...
drop table temp_first_last_close;
